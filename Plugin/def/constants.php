...
/*
 * ClassManager 에서 각 기능 관련 객체에 접근하기 위한 Dictionary 키 값 정의
 */
...
define(__NAMESPACE__ . '\FEATURE_KEY\REQUEST', 'REQUEST');
...
define(__NAMESPACE__ . '\OPTION_KEY\EXPIRE_TIMESTAMP', 'EXPIRE_TIMESTAMP');
...
define(__NAMESPACE__ . '\META_KEY\META_KEY_FOR_PLUGIN', 'TISTORY_WRITER');
define(__NAMESPACE__ . '\META_KEY\INTEGRATION_CHECK', 'INTEGRATION_CHECK');

define(__NAMESPACE__ . '\PAGE_TYPE\PAGE_SETTING', 'SETTING');
define(__NAMESPACE__ . '\PAGE_TYPE\PAGE_META_BOX', 'META_BOX');
